...
> **ARDETYPE** is a modular, scalable pipeline for bacterial whole genome sequencing (WGS) analysis, supporting both **Illumina (paired-end)** and **Oxford Nanopore** reads.  
Designed with clinical microbiology and public health applications in mind, it enables streamlined, reproducible analysis of bacterial isolates, integrating both species-agnostic and species-specific workflows.
...
- Relative paths must be specified relative to the root of the `Ardetype` repository.
