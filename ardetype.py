...
Version: 0.0
"""
import warnings, os, sys, re, argparse, yaml, subprocess, pandas as pd, shutil, time
...
def run_module_cluster(module_name, config_path, cluster_config, job_count, output_dir):
    '''
...
if __name__ == "__main__":
    ...
    if args.mode == "core":
        ...
        if args.module_jobs:
            ...
            run_module_cluster("core",config_file_path, cluster_config_path, 12, args.output_dir)
